                ...
                <div className="h-[420px] overflow-y-auto pr-2">
                    ...
                    <div className="flex flex-col gap-2">
                        {unresolvedAnomalies.map((a, i) => {
                            ...
                            const isTamper = a.anomaly_type === "document_tampered" || a.anomaly_type === "hash_mismatch";
                            ...
                            return (
                                ...
                                >
                                    <div className="flex justify-between items-start mb-1">
                                        ...
                                        <span className={`text-[10px] font-semibold ${sev.text} bg-background/30 px-1.5 py-0.5 rounded ${isTamper ? 'animate-pulse' : ''}`}>
                                            {a.severity}
                                        </span>
                                    </div>
                                    ...
                                    {isTamper && (
                                        <div className="mt-2 text-[11px]">
                                            <p className="text-red-300/80 leading-relaxed">
                                                {a.details?.message || "Document hash does not match on-chain record."}
                                            </p>
                                            {a.details?.expected_hash && a.details?.current_hash && (
                                                <div className="mt-2 p-2 rounded bg-black/20 font-mono text-[10px] space-y-0.5">
